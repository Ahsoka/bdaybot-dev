...
ADDRESS, AMAZON_PASSWORD, ASIN = dotenv_dict['ADDRESS'], dotenv_dict['AMAZON_PASSWORD'], dotenv_dict['ASIN']
...
fill_password(driver, AMAZON_PASSWORD)
...
assert len(ADDRESS.split(',')) == len(input_ids), 'Invalid data was detected in the .env file'
for info, html_id in zip(ADDRESS.split(','), input_ids):
